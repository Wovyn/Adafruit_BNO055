...
#error "On an arduino Zero, BNO055's ADR pin must be high. Fix that, then delete this line."
    ...
    bool  begin               ( TwoWire &wirePort, adafruit_bno055_opmode_t mode = OPERATION_MODE_NDOF );
    bool  begin               ( SoftwareWire &wirePort, adafruit_bno055_opmode_t mode = OPERATION_MODE_NDOF );
  ...
  private:
	...
	bool  setupHW (adafruit_bno055_opmode_t mode);
